...
const Characters = () => {
  ...
  const serializedPagination = serializePagination();
  ...
  return (
    <main id="characters-page">
      ...
      <div id="pagination">
        <div>
          <Link to={`/characters?page=${serializedPagination.first}`}>
            <button className="--first-button">First</button>
          </Link>
          <Link to={`/characters?page=${serializedPagination.previous}`}>
            <button>Prev</button>
          </Link>
          <Link to={`/characters?page=${serializedPagination.next}`}>
            <button>Next</button>
          </Link>
          <Link to={`/characters?page=${serializedPagination.last}`}>
        ...
        <ul>
          {characters.results.map((character) => (
            <Link to={`/characters/${character.id}`} key={character.id}>
              <li onClick={() => handleCharacterClick(character.id)}>
